...
async def search_web_serp(query: str, max_results: int = 5) -> List[Dict[str, str]]:
    ...
    # Add German-specific keywords to improve results
    german_keywords = ["Liedtext", "lyrics", "deutsch"]
    enhanced_query = f"{query} {' '.join(german_keywords)}"
    ...
    try:
        ...
        params = {
            ...
            "q": enhanced_query,
            "num": max_results,
            "hl": "de",  # German language results
            "gl": "de",  # Results from Germany
            "api_key": api_key
        }
